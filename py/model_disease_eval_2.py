...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Evaluate model performance on disease classification')
    parser.add_argument('--infile', default='../depmap/Model.csv.gz', 
                       help='Input CSV file path (default: ../depmap/Model.csv.gz)')
    parser.add_argument('--host', default='rbdgx1.cels.anl.gov', 
                       help='API host (default: rbdgx1.cels.anl.gov)')
    parser.add_argument('--port', default='9999', 
                       help='API port (default: 9999)')
    parser.add_argument('--key', default='CELS', 
                       help='API key (default: CELS)')
    parser.add_argument('--model', default='Qwen/Qwen3-Next-80B-A3B-Instruct', 
                       help='Model name (default: Qwen/Qwen3-Next-80B-A3B-Instruct)')
